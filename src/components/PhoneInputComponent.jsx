      ...
      flag: (
        <svg className="h-4 w-4 me-2" fill="none" viewBox="0 0 20 15">
          ...
          <g mask="url(#b)">
            ...
            <path fill="#fff" fillRule="evenodd" d="M-.898-.842L7.467 4.8V-.84h4.666V4.8l8.365-5.642L21.542.706l-6.614 4.46H19.6v4.667h-4.672l6.614 4.46-1.044 1.549L12.133 10.2v4.639H7.467V10.2L-.898 15.842l-1.044-1.548L4.672 9.833H0V5.166h4.672L-1.942.706z" clipRule="evenodd"/>
            <path fill="#C8102E" d="M8.2.5v6.533H0v1.4h8.2V14.5h3.2V8.433h8.2v-1.4H11.4V.5z"/>
            <path fill="#C8102E" d="M0 5.166h4.672L-.898.706l1.044-1.548L7.467 4.8V.5h1.4v4.3l7.321-4.642 1.044 1.548L12.133 5.166H19.6v1.4h-4.672l6.614 4.46-1.044 1.549L12.133 8.433v4.639h-1.4V8.433L3.412 12.575l-1.044-1.548L8.2 6.567H0z"/>
          </g>
        </svg>
      )
    },
      ...
      flag: (
        <svg className="h-4 w-4 me-2" fill="none" viewBox="0 0 20 15">
          ...
          <g mask="url(#c)">
            ...
            <path fill="#D80027" d="M0 5.166h4.672L-.898.706l1.044-1.548L7.467 4.8V.5h1.4v4.3l7.321-4.642 1.044 1.548L12.133 5.166H19.6v1.4h-4.672l6.614 4.46-1.044 1.549L12.133 8.433v4.639h-1.4V8.433L3.412 12.575l-1.044-1.548L8.2 6.567H0z"/>
          </g>
        </svg>
      )
    },
