...
export const MatchCard = () => {
  return (
    <div className='p-4 border-[--color-card-border] border-2 border-solid rounded-md w-full bg-[--color-card-content-bg] flex justify-between md:items-start md:flex-row flex-col'>
      <div className="info">
