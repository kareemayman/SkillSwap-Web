...
export default function Milestone({ tradeId, milestone, controls, setTrade, trade, isUserA }) {
  ...
  return (
    <>
      ...
      <div
        className={`mb-6 p-4 pr-6 rounded-lg border border-[var(--color-card-border)] dark:bg-[#252321]  flex items-start gap-3 relative`}
      >
        {controls ? (
          <div
            onClick={() => {
          ...
          <div
            className={`rounded-full ${
              myMilestone.isCompleted
                ...
                : "dark:bg-[#36322f]  text-[var(--color-text-primary)]"
