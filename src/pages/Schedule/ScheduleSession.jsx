...
export const ScheduleSession = () => {
  return (
    <div className="container mx-auto pt-8 px-16 pb-8">
      <h1 className="text-[var(--color-text-light)] font-medium text-4xl text-center sm:text-left">
        Schedule Session with Olivia
      </h1>

      <div className="flex items-center gap-3 my-8 flex-col sm:flex-row">
      ...
      <select
        name="offeringSkill"
        id="offeringSkill"
        className="bg-[#382f29] text-[var(--color-text-light)] px-4 py-2 rounded-lg shadow-sm border border-solid border-[var(--color-btn-submit-hover)] outline-none sm:w-[220px] transition-all duration-300 cursor-pointer focus:border-[var(--color-btn-submit-hover)] inline-block mb-2 sm:mb-0"
      >
      ...
      <select
        name="seekingSkill"
        id="seekingSkill"
        className="sm:ml-4 bg-[#382f29] text-[var(--color-text-light)] px-4 py-2 rounded-lg shadow-sm border border-solid border-[var(--color-btn-submit-hover)] outline-none sm:w-[220px] transition-all duration-300 cursor-pointer focus:border-[var(--color-btn-submit-hover)]"
      >
        <option value="" disabled selected>
      ...
      <button className="bg-[#e79259] text-black px-5 font-medium sm:w-[400px] transition-all duration-300 py-2 rounded-full shadow-sm hover:bg-[var(--color-btn-submit-hover)] border border-solid border-[var(--color-btn-submit-hover)] mt-4">Schedule Session</button>
    </div>
  )
}
