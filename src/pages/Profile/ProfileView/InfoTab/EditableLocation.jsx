...
export default function EditableLocation({ data, updateUserData, isOwnProfile }) {
  const [isEditing, setIsEditing] = useState(false);
  const [location, setLocation] = useState(data || { city: "", country: "" });
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="md:w-1/2 flex justify-end">
          {isEditing ? (
            ...
            isOwnProfile && <EditButton title="Edit Location" classes="" onClickHandler={() => setIsEditing(true)} />
          )}
        </div>
      </div>
