  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-4">
        <h2 className="font-semibold text-[--color-text-primary] sm:text-xl">{t("availability")}</h2>
        <div className="flex items-center gap-3">
          ...
          />
          <label htmlFor="availability" className="text-[--color-text-secondary] text-sm sm:text-base hover:cursor-pointer">
      ...
      <div className="space-y-4">
        <h2 className="font-semibold text-[--color-text-primary] sm:text-xl">{t("Trading Preferences")}</h2>
        <div className="space-y-3">
          <div className="flex items-center gap-3">
            <input
              ...
              className="rounded w-4 h-4 text-[--main-color] hover:cursor-pointer"
            />
            <label htmlFor="availableForTrade" className="text-[--color-text-secondary] text-sm sm:text-base hover:cursor-pointer">
          ...
          <div className="flex items-center gap-3">
            <input
              ...
              className="rounded w-4 h-4 text-[--main-color] hover:cursor-pointer"
            />
            <label htmlFor="availableForPaid" className="text-[--color-text-secondary] text-sm sm:text-base hover:cursor-pointer">
